...
export const Xyz = ({cards, isFetchingCards, display}) =>
{
	...
	useEffect( () => {
		getMonsterTypesByCardColor('xyz', setMonsterTypes)
	}, [])
	...
	return(
		<div style = { (display)? undefined: {'display': 'none'} } >
			<Paper style = {{ padding: '20px' }} >
				...
				<TextField label='Card Rank' onChange={ (event) => { onChange(event.target.value, setCardAssociation) } } />
			</Paper>
